...
var src_default = {
  async fetch(request, env2) {
    ...
    if (url.pathname === "/api/test") {
      ...
      let message = "";
      if (lang === "vi") {
        message = "Xin ch\xE0o t\u1EEB Marketer Suite! \u{1F680} (Ng\xF4n ng\u1EEF: Ti\u1EBFng Vi\u1EC7t)";
      } else {
        message = "Hello from Marketer Suite! \u{1F680} (Language: English)";
      }
      return new Response(
        JSON.stringify({
          success: true,
...
// .wrangler/tmp/bundle-xLtY90/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-xLtY90/middleware-loader.entry.ts
